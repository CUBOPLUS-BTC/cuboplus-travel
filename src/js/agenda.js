            ...
            return {
                html: `
                          <a href="eventinfo.html?uuid=${props.uuid}" class="block w-full rounded text-white ${color}">
                              <p class="text-white mb-2 ml-1">${info.event._def.title}</p>
                              <p class=" text-white mb-2 flex items-center"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
